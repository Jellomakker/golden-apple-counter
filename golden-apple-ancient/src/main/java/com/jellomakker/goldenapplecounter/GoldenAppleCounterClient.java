...
public class GoldenAppleCounterClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        LOGGER.info("[GoldenAppleCounter] Initialized");
    }
    ...
    private static void resetState(int[] s) { s[0] = 0; s[1] = 0; s[2] = 0; s[3] = 0; }
    ...
    public static void increment(UUID playerUuid) { COUNTS.merge(playerUuid, 1, Integer::sum); }

    public static int getCount(UUID playerUuid) { return COUNTS.getOrDefault(playerUuid, 0); }
